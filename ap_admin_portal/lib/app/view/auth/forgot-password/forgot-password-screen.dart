      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Lottie.asset(iconData, animate: true, repeat: false, alignment: Alignment.center),
          ),
          const SizedBox(height: tenDp),
          Text(
            label,
            style: const TextStyle(fontWeight: FontWeight.w400, fontFamily: FontFamily.regular, color: ThemeColor.kLightBlack),
          )
        ],
      ),
    );
      ...
      body: CustomScrollView(
        ...
        slivers: [
          AppSliverAppBar(
              ...
              title: Text(
                S.current.forgotPassword.substring(0, S.current.forgotPassword.length - 1),
          ...
          SliverFillRemaining(
            ...
            children: [
              Center(
                child: Lottie.asset(Assets.lottiesForgotPassword, animate: true, repeat: false, alignment: Alignment.center),
              ),
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius:
                          const BorderRadius.only(topLeft: Radius.circular(thirtyDp), topRight: Radius.circular(thirtyDp)),
                      color: ThemeColor.kWhite,
                      border: Border.all(color: ThemeColor.kCardBorder)),
                  child: SingleChildScrollView(
                    child: AnimatedColumnWidget(crossAxisAlignment: CrossAxisAlignment.center, children: [
                      ...
                      const SizedBox(height: twentyDp),
                      actionButtons(iconData: Assets.lottiesCall, label: '+91 98765 43210'),
                      const SizedBox(height: twentyDp),
                      actionButtons(iconData: Assets.lottiesEmail, label: 'admin@gmail.com'),
                    ]),
                  ),
                ),
              )
