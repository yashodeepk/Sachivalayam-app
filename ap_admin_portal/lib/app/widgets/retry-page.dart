...
class RetryPage extends StatefulWidget {
  ...
  const RetryPage({Key? key, required this.onTap, this.isScaffold = true}) : super(key: key);
  ...
  body() {
    return Container(
      ...
      child: AnimatedColumnWidget(children: [
        Lottie.asset(Assets.lottiesError, width: MediaQuery.of(context).size.width / 1.2),
        Text(
